...
if(mysqli_num_rows($reponse)>0){//si il y a une reponse
    while($row = mysqli_fetch_assoc($reponse)){
        ...
        echo "<td class='".$row['id_categorie']."'>".$row['id_categorie']."<input type='hidden' name='id_role' value='".$row['id_categorie']."'></td>";
        echo "<td class='".$row['nom_categorie']."'>".$row['nom_categorie']."<input type='hidden' name='nom_role' value='".$row['nom_categorie']."'></td>";
